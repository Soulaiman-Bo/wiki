        ...
        <section class=" flex items-center justify-center bg-indigo-300 h-96 p-8">
            <form class="w-[60%]">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" class="block  w-full h-20 p-4 ps-10 text-xl font-medium text-gray-700 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
