    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 min-h-[90vh] bg-gray-200 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="flex flex-col  my-6 mx-4 rounded-2xl shadow-xl shadow-gray-200">
                <a href="/dashboard/createwiki" data-modal-toggle="delete-user-modal" class="inline-flex items-center w-fit mb-5 py-2 px-3 text-sm font-medium text-center text-white bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
                                                ...
                                                <?php if ($wiki['status'] === 1) : ?>
                                                    <tr class="hover:bg-gray-100">
                                                        ...
                                                        <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                                            <form method="post" action="/wiki/archiveaction">
                                                                <input type="hidden" name="id" value="<?= $wiki['id'] ?>" />
                                                                <button type="submit" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-gradient-to-br from-yellow-400 to-yellow-600  rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform">
