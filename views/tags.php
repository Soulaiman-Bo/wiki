...
<body class="">
            ...
            <div class="flex flex-col my-6 mx-4 rounded-2xl shadow-xl shadow-gray-200">
                <div class="overflow-x-auto rounded-2xl">
                    <div class="inline-block min-w-full align-middle">
                        ...
                        <form id="addTagForm" method="post" action="/api/tag/create" class="items-center gap-5 p-9 mb-9 shadow-lg dark:bg-slate-850 dark:shadow-dark-xl relative rounded-2xl bg-white bg-clip-border">
                            <label for="title" class="block mb-2 ml-1 font-bold text-xl text-slate-700 dark:text-white/80">Add Tag
                            </label>

                            <div class="flex gap-6  items-center">
                                <input type="text" name="tagname" class=" flex-1 focus:shadow-primary-outline h-16 dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                    ...
                                    <?php foreach ($tags as $tag) : ?>
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="w-1/3 flex gap-2 p-4 space-x-2 whitespace-nowrap lg:p-5">
                                                <form  method="delete" class="deleteTagForm" action="/api/tag/deleteTag?id=<?= $tag['id'] ?>">
                                                ...
                                                <button class="btn inline-flex items-center py-2 px-3 text-sm font-medium text-center text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 hover:text-gray-900 hover:scale-[1.02] transition-all" onclick="updatetag(<?= $tag['id'] ?>)">
                                                    <svg class="mr-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5">
                                    <form method="post" id="updateForm" action="/api/tag/updatetag" class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="tagname" id="nameInput" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                                            <span id="updateTagError" class="ml-2 text-red-500"></span>
                                        </div>
    ...
    <script>
        async function updatetag(id) {
            ...
            try {
                const response = await fetch(`/api/tag/getone?id=${id}`, {
                    method: 'GET',
                });
    ...
    <script src="./../js/tagsCrud.js"></script>
